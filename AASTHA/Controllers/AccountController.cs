...
namespace AASTHA.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(AdminModel model, string ReturnUrl)
        {
            ...
            var login = db.tbl_user.FirstOrDefault(m => m.username == model.Username && m.password == model.Password);
            if (login != null)
            {
                var UserCookie = new HttpCookie("User", model.Username);
                Response.Cookies.Add(UserCookie);
                var RoleCookie = new HttpCookie("Role", login.type);
                Response.Cookies.Add(RoleCookie);
                var LayoutCookie = new HttpCookie("Layout", login.Layout);
